							...
							if(isset($data_mkterkini)){
								...
								foreach($data_mkterkini as $value){?>
									<tr class="odd gradeX">
									  ...
									  <td>
										<a <?php echo $value->IDMAKUL;?>/<?php echo $value->THSHM;?>/<?php echo $value->IDPRODI;?>/<?php echo $value->NAMAKLS;?>/<?php echo $value->SEMESTER;?>><b><?php echo $value->NAMAMK;?></b></a>
									  </td>
					...
					<div class="widget-content">
						<div class="todo">
							<ul><?php
								if(isset($data_mk)){
									foreach($data_mk as $value){
										...
										<li class="clearfix">
												...
												<div class="pull-right"> <a class="tip" href="<?php echo base_url();?>absen/detail/<?php echo $value->THSHM;?>" title="Lihat"></a></div>
											</a>
										</li><?php
									}?><?php
								}
								...
								<li>
									<a href="<?php echo base_url();?>home/sinkronisasi"><button class="btn btn-info btn-mini">Sinkronisasi Mata Kuliah >></button></a> <br><br>
								</li>
							</ul>
						</div>
					</div>
