<!--banner-->	
<div class="banner">
	<h2><a href="./">Home</a><i class="fa fa-angle-right"></i><span>Tambah Taruna</span><i class="fa fa-angle-right"></i><span>Data Alamat</span></h2></h2>
</div>
<!--//banner-->
				...
				if($data->desa != ''){?>
					<div class="form-group">
						...
						<div class="col-sm-5"><?php
							echo form_dropdown('propinsi',$ListProv, $data->prov, 'class="form-control" id="propinsi" onchange="loadKabupaten()" disabled');?>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label hor-form" for="kabupaten">Kabupaten</label>
						<div class="col-sm-5"><?php
							echo form_dropdown('kabupaten',$ListKab, $data->kab, 'class="form-control" id="kabupaten" required="required" disabled');?>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label hor-form" for="kecamatan">Kecamatan</label>
						<div class="col-sm-5"><?php
							echo form_dropdown('kecamatan',$ListKec, $data->kec, 'class="form-control" id="kecamatan" required="required" disabled');?>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label hor-form" for="desa">Desa</label>
						<div class="col-sm-5"><?php
							echo form_dropdown('desa',$ListDesa, $data->desa, 'class="form-control" id="desa" required="required" disabled');?>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label hor-form" for="desa"></label>
						<div class="col-sm-5">
							<a href="<?php echo base_url();?>entri_taruna/edit/<?php echo $this->uri->segment(3);?>/alamat/reset"><span class="fa fa-edit"> Edit Alamat</span></a>
						</div>
					</div><?php
				}else{?>
					<div class="form-group">
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button class="btn-primary btn" name="alamat" value="1">Submit</button>
