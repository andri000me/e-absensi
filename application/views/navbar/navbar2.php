            ...
            <div class="navbar-header" data-logobg="skin5">
               ...
               <a class="navbar-brand" href="<?php echo base_url();?>home">
                  ...
                  <b class="logo-icon p-l-10">
                     ...
                     <!-- Dark Logo icon -->
                     <img src="<?php echo base_url();?>template/matrix_admin/assets/images/fingerprint.jpg" alt="homepage" class=" img-rounded " width="45"/>
                  ...
                  <span class="logo-text">
                     <!-- dark Logo text -->
                     <img src="<?php echo base_url();?>template/matrix_admin/assets/images/logo-text.png" alt="homepage" class="light-logo" />
               ...
               <ul class="navbar-nav float-right">
                  ...
                  <li class="nav-item dropdown">
                     <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url();?>template/matrix_admin/assets/images/users/1.jpg" alt="user"
