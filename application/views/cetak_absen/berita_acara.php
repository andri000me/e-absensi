...
<body>
    ...
    <div id="container">
        ...
        <h3>
            <center>BERITA ACARA PERKULIAHAN
        </h3>
    ...
    <table border=1 id="meta" style="border-collapse:collapse; border: 1px solid black;">
        <thead>
            <tr>
                ...
                <th width="400px">
                    <center>Pokok & Sub Pokok Bahasan
                </th>
                <th width="400px">
                    <center>Metode Pembahasan
                </th>
                <th width="400px">
                    <center>Tugas yang Diberikan
                </th>
                <th width="100px">
                    <center>Jumlah Mahasiswa Hadir
                </th>
                <th width="100px">
                    <center>Jumlah Mahasiswa Tidak Hadir
                </th>
                <th width="100px">
                    <center>Tanda Tangan Dosen
                </th>
                <th width="100px">
                    <center>Ttd Mahasiswa
                </th>
        ...
        <tbody>
            ...
            <tr class="odd gradeX">
                <td>
                    <center><?php echo $value->PERTEMUAN; ?>
                </td>
                <?php
                ...
                <td>
                    <!-- <?= $value->TGL; ?> -->
                    <center><?php echo $dayList[$day] . " / " . $tgl_pertemuan; ?>
                </td>
                <td>
                    <center><?php echo $jm; ?> WIB
                </td>
                <td>
                    <center><?php echo $jk; ?> WIB
                </td>
                ...
                <td>
                    <center><?php echo $value->JLHHADIR; ?>
                </td>
                <td>
                    <center><?php echo $value->JLHABSEN; ?>
                </td>
                <td>
                    <center>
                </td>
