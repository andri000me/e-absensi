...
$space = "30px;";?>
	...
	<body><?php
	if($jns_absen == 2){
		$absensi = "DAFTAR HADIR <br/>UJIAN TENGAH SEMESTER (UTS)";
		...
		if ($num_rows > 0){
			...
			if($total > 0){
				...
				<br/><font size="4"><b><?php echo $absensi;?></b></font><br/><br/>
				<div id="container">
					<div id="row">
						...
						while($show_mhs = mysqli_fetch_array($mhs)){
							if($baris <= 35){
								if ($baris == 1){?>
									<table border="1" width="700" style='border-collapse:collapse;' class="makeborder">
										<thead>
											<tr height="20">
												<th rowspan="2" width="1%"><center>No</center></th>
												<th rowspan="2" width="100"><center>NIM</center></th>
												<th rowspan="2" width="150"><center>Nama Mahasiswa</center></th>
												<th rowspan="2" width="120"><center>Tanda Tangan</center></th>
												<th rowspan="2" width="50"><center>Nilai</center></th>
								...
								if($baris == 36){?>
									...
									<br/><font size="4"><b><?php echo $absensi; ?></b></font></center><br/>
									<div id="container">
										<div id="row">
											<table  border="1" width="700" style='border-collapse:collapse;' class="makeborder">
												<tr valign=top>
											...
											<table border=1 id="meta" style="border-collapse:collapse; border: 1px solid black;">
												<thead>
													<tr height="20">
														...
														<th rowspan="2" width="360"><center>Nama Mahasiswa</center></th>
