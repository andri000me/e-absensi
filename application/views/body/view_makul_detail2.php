   ...
   <div id="page-breadcrumb">
      <div class="row">
		...
		if($this->input->get('pertemuan')){?>
                     <li class="breadcrumb-item" aria-current="page"><a href="<?php echo base_url();?>makul/detail/<?php echo $value->IDMAKUL;?>/<?php echo $value->THSHM;?>/<?php echo $value->IDPRODI;?>/<?php echo $value->NAMAKLS;?>/<?php echo $value->SEMESTER;?>"
                           class="tip-bottom">
			...
			if($this->input->get('act') && $this->input->get('act') == "absendos"){?>
                     ...
                     <li class="breadcrumb-item"><a href="<?php echo current_url().'?pertemuan='.trim($this->security->xss_clean($this->input->get('pertemuan')));?>&act=absendos"
                           class="current">Berita Acara</a></li>
                     <?php
			}else{?>
                     <li class="breadcrumb-item"><a href="<?php echo current_url().'?pertemuan='.trim($this->security->xss_clean($this->input->get('pertemuan')));?>"
                           class="current">Pertemuan
                           <?php echo trim($this->security->xss_clean($this->input->get('pertemuan')));?> </a></li>
                     <?php
			}
		}else{?>
            ...
            <div class="widget-box">
               ...
               <div class="widget-content">
                  ...
                  <div class="widget-box">
                     ...
                     <div class="widget-content">
                        <form action="<?php echo base_url();?>makul/detail/<?php echo $value->IDMAKUL;?>/<?php echo $value->THSHM;?>/<?php echo $value->IDPRODI;?>/<?php echo $value->NAMAKLS;?>/<?php echo $value->SEMESTER;?>"
                  ...
                  <div class="widget-box">
                     ...
                     <div class="widget-content">
                        <form action="<?php echo base_url();?>absen/dosenact/<?php echo trim($this->security->xss_clean($this->input->get('pertemuan')));?>"
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <textarea class="span6" name="bahasan" rows="4" placeholder="Pokok bahasan materi ajar ..."
                                    required><?php echo $MATERI;?></textarea>
                              </div>
                           </div>
                           <div class="control-group">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" class="span1" name="hadir" value="<?php echo $JlhMhsHadir;?>"
                                    disabled />
                              </div>
                           </div>
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input type="text" class="span1" name="absen" value="<?php echo $JlhMhsAbsen;?>"
                                    disabled />
                              </div>
                           </div>
                     ...
                     <div class="widget-content">
                        ...
                        <div class="widget-box">
                           <div class="widget-content">
                              ...
                              <form action="<?php echo base_url();?>absen/simpan/<?php echo trim($this->security->xss_clean($this->input->get('pertemuan')));?>"
                                 method="POST" class="form-horizontal">
