                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="text-center span12 btn-icon-pg">
                                    <a class="btn btn-primary btn-mini" href="<?php echo base_url()?>absen/print_absen/<?php echo $value->IDMAKUL;?>/<?php echo $value->THSHM;?>/<?php echo $value->IDPRODI;?>/<?php echo $value->NAMAKLS;?>/<?php echo $value->SEMESTER;?>"><i
                                          class="icon-print"></i><span class="m-r-10 mdi mdi-printer"></span> Absensi Mahasiswa</a>
                                    <a class="btn btn-primary btn-mini" href="<?php echo base_url()?>absen/brt_acara/<?php echo $value->IDMAKUL;?>/<?php echo $value->THSHM;?>/<?php echo $value->IDPRODI;?>/<?php echo $value->NAMAKLS;?>/<?php echo $value->SEMESTER;?>"><i
                                          class="icon-print"></i><span class="m-r-10 mdi mdi-printer"></span> Berita Acara</a>
                                 </div>
                              </td>
                              <td>
