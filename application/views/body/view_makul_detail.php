			...
			<div class="span12">
				<div class="widget-box">
				  ...
				  <div class="widget-content">
					Silahkan pilih pertemuan 1-16 untuk mengelola bahan ajar untuk Mata Kuliah <b><?php echo $value->IDMAKUL;?> - <?php echo $value->NAMAMK;?></b>
					<div class="widget-box">
					...
					if($this->input->get('pertemuan') && $this->input->get('act') && $this->input->get('act') == "absendos"){?>
						<div class="widget-box">
							<div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
								<h5>ENTRI BERITA ACARA PERTEMUAN <?php echo trim($this->security->xss_clean($this->input->get('pertemuan')));?></h5>
							</div>
							<div class="widget-content">
								<form action="<?php echo base_url();?>absen/dosenact/<?php echo trim($this->security->xss_clean($this->input->get('pertemuan')));?>" method="POST" class="form-horizontal"><?php
						...
						<div class="widget-box">
						  <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
							<h5>ABSENSI MAHASISWA PERTEMUAN <?php echo trim($this->security->xss_clean($this->input->get('pertemuan')));?></h5>
						  </div>
						  <div class="widget-content">
							Jika data mahasiswa belum muncul/belum lengkap siahkan pilih/klik tombol <b>sinkronisasi</b> pada link berikut.
