...
class Materi extends CI_Controller{
	...
	public function index(){
		...
		if($CekMateri->num_rows() >= 1){
			...
			$this->session->set_flashdata("msg", "<br/><div class='alert bg-danger' role='alert'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Data Bahan Ajar Tidak ditemukan. Silahkan tambahkan data bahan ajar terlebih dahulu..!</div>");
		}
		$data['SifatDokumen'] = array("1" => "Open/Publik", "0" => "Private/Khusus Mahasiswa");
		$data['header'] = "header/header";
        $data['navbar'] = "navbar/navbar";
