				...
				if ($_FILES['picture']['name'] != '') {
					...
					if ($this->upload->do_upload('picture')) {
						...
						if ($this->my_model->update("profil_dosen", $where, $data)) {
							$this->session->set_flashdata("msg", "<br/><div class='alert alert-success' role='alert'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>Data berhasil diperbaharui.</div>");
							redirect('profil');
						} else {
